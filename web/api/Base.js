...
IceHRMBase.method('setTranslationsSubModules' , function(translations) {
...
IceHRMBase.method('setCustomFields', function(fields) {
    var field, parsed;
    for(var i=0;i<fields.length;i++){
        field = fields[i];
...
IceHRMBase.method('addCustomFields', function(fields) {
