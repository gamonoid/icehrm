...
import Company_overviewUserExtensionView from "./view";

class Company_overviewUserModule extends ExtensionModuleBase {
  /**
  ...
  showExtensionView() {
    ...
    ReactDOM.render(<Company_overviewUserExtensionView />, document.getElementById('content'));
  }
}

export default Company_overviewUserModule;
