...
class Advance_reportsAdminExtensionView extends React.Component {
  state = {
    reports: {},
    loading: true,
    selectedReport: null,
  ...
  fetchRemoteSource(model) {
    ...
    return this.getApiClient()
      .get(`advance_reports/source/${model}`)
      .then((response) => {
  ...
  generateReport(values) {
    ...
    this.getApiClient()
      .post(`advance_reports/reports/${selectedReport.id}/generate`, params)
      .then((response) => {
...
export default Advance_reportsAdminExtensionView;
