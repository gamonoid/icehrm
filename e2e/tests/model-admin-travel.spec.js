 ...
 *
 *   TravelProject                -> Travel Projects
 *   EmployeeTravelRecord         -> Travel Requests
 */

const MODULE = 'admin::travel';

const TABS = [
  { label: "Travel Projects", model: "TravelProject" },
  { label: "Travel Requests", model: "EmployeeTravelRecord" },
];

test.describe('admin::travel — model lists', () => {
...
test.describe('admin::travel — create/delete round trip', () => {
  for (const { label, model } of TABS) {
