...
/**
 * Model coverage — admin::employeehistory
 *
 ...
 *
 *   EmployeeDataHistory          -> Employee Basic Details
 */

const MODULE = 'admin::employeehistory';

const TABS = [
  { label: "Employee Basic Details", model: "EmployeeDataHistory" },
];

test.describe('admin::employeehistory — model lists', () => {
...
test.describe('admin::employeehistory — create/delete round trip', () => {
  for (const { label, model } of TABS) {
