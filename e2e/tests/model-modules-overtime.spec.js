...
/**
 * Model coverage — modules::overtime
 *
 ...
 *
 *   MyOvertime                   -> Overtime Requests  [not in the registered model map]
 *   EmployeeOvertime             -> Direct Reports
 *   EmployeeOvertimeApproval     -> Approvals
 */

const MODULE = 'modules::overtime';

const TABS = [
  { label: "Overtime Requests", model: "MyOvertime" },
  { label: "Direct Reports", model: "EmployeeOvertime" },
  { label: "Approvals", model: "EmployeeOvertimeApproval" },
];

test.describe('modules::overtime — model lists', () => {
...
test.describe('modules::overtime — create/delete round trip', () => {
  for (const { label, model } of TABS) {
