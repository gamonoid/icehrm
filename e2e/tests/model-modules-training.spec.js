...
/**
 * Model coverage — modules::training
 *
 ...
 *
 *   TrainingSessionWithCourse    -> All Training Sessions
 *   EmployeeTrainingSession      -> My Training Sessions
 *   SubEmployeeTraining          -> Training Sessions of Direct Reports  [not in the registered model map]
 *   CoordinatedTrainingSession   -> Training Sessions Coordinated by Me
 */

const MODULE = 'modules::training';

const TABS = [
  { label: "All Training Sessions", model: "TrainingSessionWithCourse" },
  { label: "My Training Sessions", model: "EmployeeTrainingSession" },
  { label: "Training Sessions of Direct Reports", model: "SubEmployeeTraining" },
  { label: "Training Sessions Coordinated by Me", model: "CoordinatedTrainingSession" },
];

test.describe('modules::training — model lists', () => {
...
test.describe('modules::training — create/delete round trip', () => {
  for (const { label, model } of TABS) {
