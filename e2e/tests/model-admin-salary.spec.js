 ...
 *
 *   SalaryComponentType          -> Salary Component Types
 *   SalaryComponent              -> Salary Components
 *   EmployeeSalary               -> Salary
 */

const MODULE = 'admin::salary';

const TABS = [
  { label: "Salary Component Types", model: "SalaryComponentType" },
  { label: "Salary Components", model: "SalaryComponent" },
  { label: "Salary", model: "EmployeeSalary" },
];

test.describe('admin::salary — model lists', () => {
...
test.describe('admin::salary — create/delete round trip', () => {
  for (const { label, model } of TABS) {
