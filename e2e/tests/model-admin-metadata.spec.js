...
const MODULE = 'admin::metadata';

const TABS = [
  { label: "Countries", model: "Country" },
  { label: "Provinces", model: "Province" },
  { label: "Currency Types", model: "CurrencyType" },
  { label: "Nationality", model: "Nationality" },
  { label: "Ethnicity", model: "Ethnicity" },
  { label: "Immigration Status", model: "ImmigrationStatus" },
];

test.describe('admin::metadata — model lists', () => {
...
test.describe('admin::metadata — create/delete round trip', () => {
  for (const { label, model } of TABS) {
