...
/**
 * Model coverage — admin::custom_fields
 *
...
const MODULE = 'admin::custom_fields';

const TABS = [
  { label: "Custom Fields", model: "CustomField" },
];

test.describe('admin::custom_fields — model lists', () => {
...
test.describe('admin::custom_fields — create/delete round trip', () => {
  for (const { label, model } of TABS) {
