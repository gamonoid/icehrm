...
/**
 * Model coverage — admin::employees
 *
 ...
 *
 *   EmployeeCareer               -> Work History
 *   EmployeeSkill                -> Skills
 *   EmployeeEducation            -> Education
 *   EmployeeCertification        -> Certifications
 *   EmployeeLanguage             -> Languages
 *   EmployeeDependent            -> Dependents
 *   EmergencyContact             -> Contacts
 *   TerminatedEmployee           -> Resigned  [not in the registered model map]
 *   ArchivedEmployee             -> Archived
 *   Employee                     -> reached through another tab's form
 */

const MODULE = 'admin::employees';

const TABS = [
  { label: "Work History", model: "EmployeeCareer" },
  { label: "Skills", model: "EmployeeSkill" },
  { label: "Education", model: "EmployeeEducation" },
  { label: "Certifications", model: "EmployeeCertification" },
  { label: "Languages", model: "EmployeeLanguage" },
  { label: "Dependents", model: "EmployeeDependent" },
  { label: "Contacts", model: "EmergencyContact" },
  { label: "Resigned", model: "TerminatedEmployee" },
  { label: "Archived", model: "ArchivedEmployee" },
];

test.describe('admin::employees — model lists', () => {
...
test.describe('admin::employees — create/delete round trip', () => {
  for (const { label, model } of TABS) {
