...
/**
 * Model coverage — extension::candidates|admin
 *
 ...
 *
 *   Application                  -> reached through another tab's form
 *   Call                         -> reached through another tab's form
 *   Candidate                    -> reached through another tab's form
 *   CandidateForHiringStage      -> reached through another tab's form
 *   CandidateNote                -> reached through another tab's form
 *   HiringPipeline               -> reached through another tab's form
 *   Interview                    -> reached through another tab's form
 */

const MODULE = 'extension::candidates|admin';

const MODELS = ["Application", "Call", "Candidate", "CandidateForHiringStage", "CandidateNote", "HiringPipeline", "Interview"];

test.describe('extension::candidates|admin — module surface', () => {
