 ...
 *   EmployeeOvertime             -> Overtime Requests
 */

const MODULE = 'admin::overtime';

const TABS = [
  { label: "Overtime Categories", model: "OvertimeCategory" },
  { label: "Overtime Requests", model: "EmployeeOvertime" },
];

test.describe('admin::overtime — model lists', () => {
...
test.describe('admin::overtime — create/delete round trip', () => {
  for (const { label, model } of TABS) {
