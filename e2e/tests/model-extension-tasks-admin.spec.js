...
/**
 * Model coverage — extension::tasks|admin
 *
 ...
 *
 *   TaskList                     -> reached through another tab's form
 *   TaskListAssignment           -> reached through another tab's form
 */

const MODULE = 'extension::tasks|admin';

const MODELS = ["TaskList", "TaskListAssignment"];

test.describe('extension::tasks|admin — module surface', () => {
