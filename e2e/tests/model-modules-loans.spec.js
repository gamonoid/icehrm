 ...
 *
 *   EmployeeCompanyLoan          -> Loans Taken  (tab entity: MyLoan)
 */

const MODULE = 'modules::loans';

const TABS = [
  { label: "Loans Taken", model: "EmployeeCompanyLoan" },
];

test.describe('modules::loans — model lists', () => {
...
test.describe('modules::loans — create/delete round trip', () => {
  for (const { label, model } of TABS) {
