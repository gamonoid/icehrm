 ...
 *
 *   CompanyLoan                  -> Loan Types
 *   EmployeeCompanyLoan          -> Employee Loans
 */

const MODULE = 'admin::loans';

const TABS = [
  { label: "Loan Types", model: "CompanyLoan" },
  { label: "Employee Loans", model: "EmployeeCompanyLoan" },
];

test.describe('admin::loans — model lists', () => {
...
test.describe('admin::loans — create/delete round trip', () => {
  for (const { label, model } of TABS) {
