...
/**
 * Model coverage — admin::fieldnames
 *
 ...
 *
 *   FieldNameMapping             -> Field Names
 */

const MODULE = 'admin::fieldnames';

const TABS = [
  { label: "Field Names", model: "FieldNameMapping" },
];

test.describe('admin::fieldnames — model lists', () => {
...
test.describe('admin::fieldnames — create/delete round trip', () => {
  for (const { label, model } of TABS) {
