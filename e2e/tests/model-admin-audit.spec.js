 ...
 *
 *   Audit                        -> Audit Log
 *   EmailLogEntry                -> Email Log
 */

const MODULE = 'admin::audit';

const TABS = [
  { label: "Audit Log", model: "Audit" },
  { label: "Email Log", model: "EmailLogEntry" },
];

test.describe('admin::audit — model lists', () => {
...
test.describe('admin::audit — create/delete round trip', () => {
  for (const { label, model } of TABS) {
