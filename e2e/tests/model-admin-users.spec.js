...
const TABS = [
  ...
  { label: "User Roles", model: "UserRole" },
  { label: "User Invitations", model: "UserInvitation" },
];

test.describe('admin::users — model lists', () => {
...
test.describe('admin::users — create/delete round trip', () => {
  for (const { label, model } of TABS) {
