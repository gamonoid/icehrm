...
/**
 * Model coverage — admin::performance
 *
 ...
 *   ReviewFeedback               -> Feedback Requests
 *   ReviewTemplate               -> Employee Feedback Templates
 *   EmployeeGoal                 -> Employee Goals
 */

const MODULE = 'admin::performance';

const TABS = [
  { label: "Performance Reviews", model: "PerformanceReview" },
  { label: "Feedback Requests", model: "ReviewFeedback" },
  { label: "Employee Feedback Templates", model: "ReviewTemplate" },
  { label: "Employee Goals", model: "EmployeeGoal" },
];

test.describe('admin::performance — model lists', () => {
...
test.describe('admin::performance — create/delete round trip', () => {
  for (const { label, model } of TABS) {
