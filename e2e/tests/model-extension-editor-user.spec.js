...
/**
 * Model coverage — extension::editor|user
 *
 ...
 *
 *   Content                      -> reached through another tab's form
 */

const MODULE = 'extension::editor|user';

const MODELS = ["Content"];

test.describe('extension::editor|user — module surface', () => {
