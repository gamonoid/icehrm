 ...
 *
 *   EmployeeLeaveEntitlement     -> Leave Entitlement  [not in the registered model map]
 *   EmployeeLeave                -> All My Leaves  (tab entity: MyLeave)
 *   EmployeeLeave                -> Approved Leave  (tab entity: MyLeaveApproved)
 *   EmployeeLeave                -> Pending Leave  (tab entity: MyLeave)
 *   EmployeeLeave                -> Leave Requests  (tab entity: SubLeave)
 *   EmployeeLeave                -> Cancellation Requests  (tab entity: SubLeave)
 *   EmployeeLeaveApprove         -> Approval Requests  (tab entity: LeaveApproval)
 */

const MODULE = 'modules::leaves';

const TABS = [
  { label: "Leave Entitlement", model: "EmployeeLeaveEntitlement" },
  { label: "All My Leaves", model: "EmployeeLeave" },
  { label: "Approved Leave", model: "EmployeeLeave" },
  { label: "Pending Leave", model: "EmployeeLeave" },
  { label: "Leave Requests", model: "EmployeeLeave" },
  { label: "Cancellation Requests", model: "EmployeeLeave" },
  { label: "Approval Requests", model: "EmployeeLeaveApprove" },
];

test.describe('modules::leaves — model lists', () => {
...
test.describe('modules::leaves — create/delete round trip', () => {
  for (const { label, model } of TABS) {
