...
/**
 * Model coverage — extension::team|admin
 *
 ...
 *
 *   Team                         -> reached through another tab's form
 *   TeamMember                   -> reached through another tab's form
 */

const MODULE = 'extension::team|admin';

const MODELS = ["Team", "TeamMember"];

test.describe('extension::team|admin — module surface', () => {
