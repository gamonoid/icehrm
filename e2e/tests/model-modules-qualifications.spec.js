...
/**
 * Model coverage — modules::qualifications
 *
...
const MODULE = 'modules::qualifications';
...
test.describe('modules::qualifications — model lists', () => {
...
test.describe('modules::qualifications — create/delete round trip', () => {
  for (const { label, model } of TABS) {
