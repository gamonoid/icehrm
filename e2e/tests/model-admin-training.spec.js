 ...
 *   EmployeeTrainingSession      -> Employee Training Sessions
 */

const MODULE = 'admin::training';

const TABS = [
  { label: "Courses", model: "Course" },
  { label: "Training Sessions", model: "TrainingSession" },
  { label: "Employee Training Sessions", model: "EmployeeTrainingSession" },
];

test.describe('admin::training — model lists', () => {
...
test.describe('admin::training — create/delete round trip', () => {
  for (const { label, model } of TABS) {
