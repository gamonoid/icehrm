...
/**
 * Model coverage — admin::documents
 *
 ...
 *   PayslipDocument              -> Employee Payslip
 */

const MODULE = 'admin::documents';

const TABS = [
  { label: "Company Documents", model: "CompanyDocument" },
  { label: "Document Types", model: "Document" },
  { label: "Employee Documents", model: "EmployeeDocument" },
  { label: "Employee Payslip", model: "PayslipDocument" },
];

test.describe('admin::documents — model lists', () => {
...
test.describe('admin::documents — create/delete round trip', () => {
  for (const { label, model } of TABS) {
