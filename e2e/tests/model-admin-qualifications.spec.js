...
/**
 * Model coverage — admin::qualifications
 *
...
const MODULE = 'admin::qualifications';

const TABS = [
  { label: "Skills", model: "Skill" },
  { label: "Education", model: "Education" },
  { label: "Certifications", model: "Certification" },
  { label: "Languages", model: "Language" },
];

test.describe('admin::qualifications — model lists', () => {
...
test.describe('admin::qualifications — create/delete round trip', () => {
  for (const { label, model } of TABS) {
