...
/**
 * Model coverage — modules::dependents
 *
...
const MODULE = 'modules::dependents';

const TABS = [
  { label: "Dependents", model: "EmployeeDependent" },
];

test.describe('modules::dependents — model lists', () => {
...
test.describe('modules::dependents — create/delete round trip', () => {
  for (const { label, model } of TABS) {
