...
/**
 * Model coverage — extension::tasks|user
 *
 ...
 *
 *   MyTaskList                   -> reached through another tab's form
 */

const MODULE = 'extension::tasks|user';

const MODELS = ["MyTaskList"];

test.describe('extension::tasks|user — module surface', () => {
