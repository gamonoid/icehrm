...
const MODULE = 'admin::jobs';

const TABS = [
  { label: "Job Titles", model: "JobTitle" },
  { label: "Pay Grades", model: "PayGrade" },
  { label: "Employment Status", model: "EmploymentStatus" },
];

test.describe('admin::jobs — model lists', () => {
...
test.describe('admin::jobs — create/delete round trip', () => {
  for (const { label, model } of TABS) {
