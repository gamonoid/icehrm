 ...
 *
 *   MyTravel                     -> Travel Requests  [not in the registered model map]
 *   SubTravel                    -> Travel Requests (Direct Reports)  [not in the registered model map]
 *   TravelApproval               -> Travel Requests for Approval  [not in the registered model map]
 *   EmployeeTravelRecord         -> reached through another tab's form
 */

const MODULE = 'modules::travel';

const TABS = [
  { label: "Travel Requests", model: "MyTravel" },
  { label: "Travel Requests (Direct Reports)", model: "SubTravel" },
  { label: "Travel Requests for Approval", model: "TravelApproval" },
];

test.describe('modules::travel — model lists', () => {
...
test.describe('modules::travel — create/delete round trip', () => {
  for (const { label, model } of TABS) {
