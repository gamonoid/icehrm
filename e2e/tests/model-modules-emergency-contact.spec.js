...
/**
 * Model coverage — modules::emergency_contact
 *
...
const MODULE = 'modules::emergency_contact';

const TABS = [
  { label: "Emergency Contacts", model: "EmergencyContact" },
];

test.describe('modules::emergency_contact — model lists', () => {
...
test.describe('modules::emergency_contact — create/delete round trip', () => {
  for (const { label, model } of TABS) {
