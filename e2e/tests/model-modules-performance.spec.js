...
/**
 * Model coverage — modules::performance
 *
 ...
 *
 *   MyPerformanceReview          -> Self Assessments  [not in the registered model map]
 *   MyReviewFeedback             -> Feedback Requests  [not in the registered model map]
 *   CoordinatedPerformanceReview -> reached through another tab's form
 *   PerformanceReview            -> reached through another tab's form
 *   ReviewFeedback               -> reached through another tab's form
 */

const MODULE = 'modules::performance';

const TABS = [
  { label: "Self Assessments", model: "MyPerformanceReview" },
  { label: "Feedback Requests", model: "MyReviewFeedback" },
];

test.describe('modules::performance — model lists', () => {
...
test.describe('modules::performance — create/delete round trip', () => {
  for (const { label, model } of TABS) {
