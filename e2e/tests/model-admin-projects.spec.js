...
const MODULE = 'admin::projects';

const TABS = [
  { label: "Projects", model: "Project" },
  { label: "Employee Project Assignments", model: "EmployeeProject" },
  { label: "Clients", model: "Client" },
];

test.describe('admin::projects — model lists', () => {
...
test.describe('admin::projects — create/delete round trip', () => {
  for (const { label, model } of TABS) {
