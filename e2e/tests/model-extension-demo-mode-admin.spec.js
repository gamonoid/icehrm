...
/**
 * Model coverage — extension::demo-mode|admin
 *
 ...
 *
 *   DemoDataEntry                -> reached through another tab's form
 */

const MODULE = 'extension::demo-mode|admin';

const MODELS = ["DemoDataEntry"];

test.describe('extension::demo-mode|admin — module surface', () => {
