...
/**
 * Model coverage — extension::company_assets|admin
 *
 ...
 *
 *   AssetType                    -> reached through another tab's form
 *   CompanyAsset                 -> reached through another tab's form
 */

const MODULE = 'extension::company_assets|admin';

const MODELS = ["AssetType", "CompanyAsset"];

test.describe('extension::company_assets|admin — module surface', () => {
