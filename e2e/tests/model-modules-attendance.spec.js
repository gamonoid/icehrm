...
/**
 * Model coverage — modules::attendance
 *
 ...
 *
 *   MyAttendance                 -> Attendance  [not in the registered model map]
 *   Attendance                   -> reached through another tab's form
 */

const MODULE = 'modules::attendance';

const TABS = [
  { label: "Attendance", model: "MyAttendance" },
];

test.describe('modules::attendance — model lists', () => {
...
test.describe('modules::attendance — create/delete round trip', () => {
  for (const { label, model } of TABS) {
