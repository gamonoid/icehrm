...
/**
 * Model coverage — extension::expenses|admin
 *
 ...
 *
 *   EmployeeExpense              -> reached through another tab's form
 *   EmployeeExpenseApproval      -> reached through another tab's form
 *   ExpensesCategory             -> reached through another tab's form
 *   ExpensesPaymentMethod        -> reached through another tab's form
 */

const MODULE = 'extension::expenses|admin';

const MODELS = ["EmployeeExpense", "EmployeeExpenseApproval", "ExpensesCategory", "ExpensesPaymentMethod"];

test.describe('extension::expenses|admin — module surface', () => {
