...
/**
 * Model coverage — extension::learn|admin
 *
 ...
 *
 *   LmsCourse                    -> reached through another tab's form
 *   LmsEmployeeCourse            -> reached through another tab's form
 *   LmsEmployeeLesson            -> reached through another tab's form
 *   LmsLesson                    -> reached through another tab's form
 */

const MODULE = 'extension::learn|admin';

const MODELS = ["LmsCourse", "LmsEmployeeCourse", "LmsEmployeeLesson", "LmsLesson"];

test.describe('extension::learn|admin — module surface', () => {
