...
/**
 * Model coverage — extension::esign|admin
 *
 ...
 *
 *   EsignAuditLog                -> reached through another tab's form
 *   EsignDocument                -> reached through another tab's form
 *   EsignedDoc                   -> reached through another tab's form
 */

const MODULE = 'extension::esign|admin';

const MODELS = ["EsignAuditLog", "EsignDocument", "EsignedDoc"];

test.describe('extension::esign|admin — module surface', () => {
